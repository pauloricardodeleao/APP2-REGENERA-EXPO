...
export const CardScreen: React.FC<ScreenProps> = ({ onNavigate, onBack }) => {
  ...
  return (
    <div className="relative h-full bg-transparent flex flex-col animate-in slide-in-from-right duration-300">
      
      {/* BENEFITS MODAL */}
      {showBenefits && (
         <div className="fixed inset-0 z-[120] bg-black/80 backdrop-blur-md flex items-end sm:items-center justify-center animate-in fade-in">
      ...
      <div className="flex-1 overflow-y-auto no-scrollbar">
          ...
          {activeTab === 'config' && (
             <div className="px-6 mt-6 pb-8 space-y-4 animate-in fade-in">
